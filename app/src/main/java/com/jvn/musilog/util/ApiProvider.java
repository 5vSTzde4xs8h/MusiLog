...
public class ApiProvider {
  ...
  private static void makeSpotifyApi() {
    /*
    Adapted from spotify-web-api-java example code
    https://github.com/spotify-web-api-java/spotify-web-api-java/blob/3cc311d395e1aa25f7794e566bad6dbab33a2a5f/examples/authorization/client_credentials/ClientCredentialsExample.java
    */
