...
public class Login extends AppCompatActivity {
    ...
    //TextInputEditText inputEmailtest, inputPasswordtest;
  @Override
                      ...
                      .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                          ...
                          public void onComplete(@NonNull Task<AuthResult> task) {
                              if (task.isSuccessful()) {
                                  ...
                                  Toast.makeText(Login.this, "Welcome to MusiLog!",Toast.LENGTH_SHORT).show();
                                  ...
                                  Toast.makeText(Login.this, "Unable to login, Please check credentials",
