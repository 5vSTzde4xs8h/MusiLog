...
public class TrackMetadataTest {
  ...
  public void testFromSpotify() {
    ...
    assertEquals(spotifyMetadata.getTitle(), "Mane Mane Psychotropic");
    assertEquals(spotifyMetadata.getArtistLine(), "Kairikibear");
  ...
  public void testFromYouTube() {
    ...
    assertEquals(youTubeMetadata.getArtistLine(), "Neru OFFICIAL");
